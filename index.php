                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p> <button type = "button" class="btn-success" onclick="addToCart('bronton')"> Add to Cart</button> <a href="#" class="btn btn-primary" role="button">See Details</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p>  <button type = "button" class="btn-success" onclick="addToCart('ebmx')"> Add to Cart</button> <a href="#" class="btn btn-primary" role="button">See Details</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p>  <button type = "button" class="btn-success" onclick="addToCart('f65')"> Add to Cart</button> <a href="#" class="btn btn-primary" role="button">See Details</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
